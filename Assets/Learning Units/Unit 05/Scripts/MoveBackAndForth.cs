...
public class MoveBackAndForth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach(GameObject moveObj in ObjectsToMove)
        {
            startPositions.Add(moveObj.transform.position); // one of these lists needs this kind of position...
            endPositions.Add(moveObj.transform.position + new Vector3(0,0,10f)); // another one needs another...
        }
    }
